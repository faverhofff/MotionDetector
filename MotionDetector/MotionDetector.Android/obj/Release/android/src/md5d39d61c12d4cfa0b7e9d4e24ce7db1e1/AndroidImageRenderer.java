...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MotionDetector.Droid.AndroidImageRenderer, MotionDetector.Android", AndroidImageRenderer.class, __md_methods);
	}
	...
	public AndroidImageRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		...
		if (getClass () == AndroidImageRenderer.class)
			mono.android.TypeManager.Activate ("MotionDetector.Droid.AndroidImageRenderer, MotionDetector.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
	...
	public AndroidImageRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == AndroidImageRenderer.class)
			mono.android.TypeManager.Activate ("MotionDetector.Droid.AndroidImageRenderer, MotionDetector.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
	...
	public AndroidImageRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == AndroidImageRenderer.class)
			mono.android.TypeManager.Activate ("MotionDetector.Droid.AndroidImageRenderer, MotionDetector.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
