package md55fcffd656279cb1a5e512024c748879c;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GalaSoft.MvvmLight.Views.DialogService+OnDismissListener, GalaSoft.MvvmLight.Platform, Version=5.2.0.37256, Culture=neutral, PublicKeyToken=null", DialogService_OnDismissListener.class, __md_methods);
	}
	...
	public DialogService_OnDismissListener ()
	{
		...
		if (getClass () == DialogService_OnDismissListener.class)
			mono.android.TypeManager.Activate ("GalaSoft.MvvmLight.Views.DialogService+OnDismissListener, GalaSoft.MvvmLight.Platform, Version=5.2.0.37256, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
