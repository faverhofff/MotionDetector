...
extern void *mono_aot_module_MotionDetector_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_MotionDetector_info;
...
{
	mono_aot_register_module (mono_aot_module_MotionDetector_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_MotionDetector_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MotionDetector.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
