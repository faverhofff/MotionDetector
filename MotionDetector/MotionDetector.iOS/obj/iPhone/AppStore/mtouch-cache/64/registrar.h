...
@class MotionDetector_iOS_IosImageRenderer;
@class MotionDetector_iOS_PinItemViewRenderer;
@class MotionDetector_iOS_ZFRippleButton;
...
@interface MotionDetector_iOS_IosImageRenderer : Xamarin_Forms_Platform_iOS_ImageRenderer {
}
	-(id) init;
@end

@interface MotionDetector_iOS_PinItemViewRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(void) layoutSubviews;
	-(id) init;
@end

@interface MotionDetector_iOS_ZFRippleButton : UIButton {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
